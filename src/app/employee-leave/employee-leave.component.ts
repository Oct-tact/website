...
//     const currentUser = JSON.parse(localStorage.getItem('currentUser') || '{}');
//     if (currentUser) {
//       this.leaveRequests = savedRequests.filter((request: LeaveRequest) => request.role  === currentUser.role);
//       this.dataSource.data = this.leaveRequests;
//     }
//   }
...
//   saveLeaveRequests(): void {
//     const savedRequests = JSON.parse(localStorage.getItem('employeeLeaveRequests') || '[]');
//     const allRequests = [...savedRequests.filter((request: LeaveRequest) => request.role !== this.role), ...this.leaveRequests];
